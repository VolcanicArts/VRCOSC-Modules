...
public class HapticControlModule : Module
{
    ...
    protected override void OnPreLoad()
    {
        ...
        RegisterParameter<bool>(HapticControlParameter.TriggerLeftDirect, "VRCOSC/VR/Haptics/TriggerLeft/*/*/*", ParameterMode.Read, "Trigger Left Direct", "Becoming true causes a haptic trigger in the left controller using the wildcards\nFor example:\n Writing 'VRCOSC/VR/Haptics/TriggerLeft/2/0.5/0.75' will trigger haptics in the left controller with a 2 second duration, 0.5 frequency, and 0.75 amplitude");
        RegisterParameter<bool>(HapticControlParameter.TriggerRightDirect, "VRCOSC/VR/Haptics/TriggerRight/*/*/*", ParameterMode.Read, "Trigger Right Direct", "Becoming true causes a haptic trigger in the right controller using the wildcards\nFor example:\n Writing 'VRCOSC/VR/Haptics/TriggerRight/2/0.5/0.75' will trigger haptics in the right controller with a 2 second duration, 0.5 frequency, and 0.75 amplitude");
    }
