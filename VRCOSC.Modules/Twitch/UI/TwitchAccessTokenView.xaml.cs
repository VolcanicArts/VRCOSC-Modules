...
public partial class TwitchAccessTokenView
{
    ...
    private string getUrl() => "https://id.twitch.tv/oauth2/authorize?"
                               ...
                               + "&scope=user:bot channel:bot user:read:chat user:write:chat moderator:read:followers channel:read:subscriptions channel:read:redemptions bits:read channel:read:goals channel:read:hype_train"
